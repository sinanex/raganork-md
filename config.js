...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/y8owpS2 Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: process.env.SESSION.trim() || 'Raganork~f13d37a2ef16b46e9bb104945ed9451d:713564737255755a3567593d',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f","deb80cd12ababea1c9b9a8ad6ce3fab2","78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us',
    BOT_INFO: process.env.BOT_INFO || 'sinanex-md;sinan;0;https://imgur.com/y8owpS2;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"sinnnn",
    BOT_NAME: process.env.BOT_NAME || 'Raganork',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'sinan;sinanex MD bot;https://imgur.com/y8owpS2' : process.env.AUDIO_DATA,
