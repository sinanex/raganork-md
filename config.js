...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "hhttps://imgur.com/y8owpS2 Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'SINANEX-MD;SINAN;0;https://imgur.com/y8owpS2;https://chat.whatsapp.com/Dt3C4wrt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || 'SINANEX-MD',
    ...
    SUDO: process.env.SUDO || "918089309204",
